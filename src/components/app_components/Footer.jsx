        ...
        <footer className="flex flex-wrap justify-center bg-primary w-full px-5 md:px-10 lg:px-[60px] xl:px-20 pt-10 md:pt-[28.89px] pb-5">
            <div className="flex flex-wrap lg:flex-nowrap w-full lg:justify-between">
                ...
                <span className="md:w-full lg:w-auto lg:mr-28 xl:mr-[345px] md:pb-[60px]">
                    <img src="./src/assets/White Logo.png" className="h-[36.11px]" alt="footer logo" />
                    <p className="pt-5 text-base font-normal [line-height: 19.2px] md:w-[413px] lg:w-[438px] text-left">
            ...
            {/* Terms & Copyrights */}
            <div className="w-ful md:w-[630px] border-t border-white flex justify-center mt-10 pt-2 px-[39px] *:text-sm *:font-medium [line-height: 16.94px]">
